canvas=new LzCanvas(null,{__LZproxied:"false",appbuilddate:"2010-04-01T23:01:08Z",bgcolor:16777215,embedfonts:true,font:"Helvetica,Sans",fontsize:11,fontstyle:"plain",height:"100%",lpsbuild:"16044 /Users/maxcarlson/openlaszlo/trunk-clean",lpsbuilddate:"2010-03-31T22:46:58Z",lpsrelease:"Latest",lpsversion:"5.0.x",runtime:"dhtml",width:"100%"});Mixin.make("DrawviewShared",["$lzsc$initialize",function($0,$1,$2,$3){
...
var $0=LzCSSStyle,$1=LzCSSStyleRule;$0._addRule(new $1("canvas",{"background-color":8553090,"font-size":18}));$0._addRule(new $1("basepanel",{"base-color":3355443,"border-color":14079702,"border-width":0,"corner-radius":3,"highlight-color":10079487}));$0._addRule(new $1("buttongroup",{"divider-gradient":"top,#797979 0,#b0b0b0 50,#797979 100"}));$0._addRule(new $1("button",{"corner-radius":100,"gradient-fill-disabled":"top,#f6f6f6 0,#eeeeee 100","gradient-fill-over":"top,#d6d6d6 0,#f6f6f6 100","gradient-fill-up":"top,#f6f6f6 0,#d6d6d6 100","text-color-up":5197647,"text-padding":6}))
})();Class.make("$lzc$class_button",["$m283",function($0){
...
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$delegates:["oninit","$m283",null]},$lzc$class_button.attributes)
...
}}})($lzc$class_virtualdrawview$button);Class.make("$lzc$class_m288",["$m284",function($0){
with(this){
var $1=immediateparent.width;if($1!==this["width"]||!this.inited){
this.setAttribute("width",$1)
}}},"$m285",function(){
